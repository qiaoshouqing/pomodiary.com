...
export function Headline() {
  return (
    <div className="max-w-2xl">
      ...
      >
        <Balancer>
          ...
          {/*我热爱开发，设计，创新，享受生活，以及在未知领域中探索。*/}
            POMODIARY crafts AI tools you'll actually want to use - useful enough to keep, fun enough to share.
        </Balancer>
      </motion.p>
      <motion.div
      ...
      >
        <SocialLink
          href="https://pomodiary.com/twitter"
          aria-label="我的推特"
          platform="twitter"
        />
        {/*<SocialLink*/}
        {/*  href="https://pomodiary.com/youtube"*/}
        {/*  aria-label="我的 YouTube"*/}
        {/*  platform="youtube"*/}
        {/*/>*/}
        <SocialLink
          href="https://pomodiary.com/bilibili"
          aria-label="我的 Bilibili"
          platform="bilibili"
        />
        {/*<SocialLink*/}
        {/*  href="https://pomodiary.com/github"*/}
        {/*  aria-label="我的 GitHub"*/}
        {/*  platform="github"*/}
        {/*/>*/}
        {/*<SocialLink*/}
        {/*  href="https://pomodiary.com/tg"*/}
        {/*  aria-label="我的 Telegram"*/}
        {/*  platform="telegram"*/}
        {/*/>*/}
        {/*<SocialLink href="/feed.xml" platform="rss" aria-label="RSS 订阅" />*/}
        <SocialLink
          href="mailto:qiaoshouqing@foxmail.com"
          aria-label="我的邮箱"
          platform="mail"
        />
      </motion.div>
