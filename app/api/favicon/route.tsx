...
const faviconMapper: { [key: string]: string } = {
  '((?:zolplay.cn)|(?:zolplay.com)|(?:cn.zolplay.com))':
    'https://pomodiary.com/favicons/zolplay.png',
  '(?:github.com)': 'https://pomodiary.com/favicons/github.png',
  '((?:t.co)|(?:twitter.com)|(?:x.com))':
    'https://pomodiary.com/favicons/twitter.png',
  'coolshell.cn': 'https://pomodiary.com/favicons/coolshell.png',
  'vercel.com': 'https://pomodiary.com/favicons/vercel.png',
  'nextjs.org': 'https://pomodiary.com/favicons/nextjs.png',
}
...
export async function GET(req: NextRequest) {
  ...
  let iconUrl = 'https://pomodiary.com/favicon_blank.png'
